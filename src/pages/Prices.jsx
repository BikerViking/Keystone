    ...
    <MotionSection className="w-full py-8 px-4 sm:px-8">
      ...
      <div className="mx-auto w-full max-w-3xl space-y-8">
        ...
        <section aria-labelledby="standard-fees-heading">
          <h2 id="standard-fees-heading" className="mb-2 text-2xl font-semibold text-charcoal">
            Standard Notary Fees
          </h2>
          <ul className="list-disc pl-5 text-deepgray space-y-1">
        ...
        <section aria-labelledby="travel-fees-heading">
          <h2 id="travel-fees-heading" className="mb-2 text-2xl font-semibold text-charcoal">
            Mobile/Travel Fees
          </h2>
          <ul className="list-disc pl-5 text-deepgray space-y-1">
        ...
        <section aria-labelledby="surcharges-heading">
          <h2 id="surcharges-heading" className="mb-2 text-2xl font-semibold text-charcoal">
            Surcharges
          </h2>
          <ul className="list-disc pl-5 text-deepgray space-y-1">
        ...
        <section aria-labelledby="specialized-heading">
          <h2 id="specialized-heading" className="mb-2 text-2xl font-semibold text-charcoal">
        ...
        <section aria-labelledby="notes-heading">
          <h2 id="notes-heading" className="mb-2 text-2xl font-semibold text-charcoal">Notes</h2>
          <ul className="list-disc pl-5 text-deepgray space-y-1">
