  ...
  return (
    <MotionSection className="container space-y-6 text-center md:text-left">
      <div className="relative mb-6 flex items-center justify-center gap-4 pb-4 after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-gray-700/60 md:justify-start">
        <h2 className="credentials-heading text-3xl font-serif font-semibold tracking-wide heading-gradient text-silver">
          Credentials
        </h2>
        <img
          src="/nna-badge.png"
          alt="Certified NNA Notary Signing Agent badge"
          className="h-16 w-auto flex-none sm:h-20 lg:h-24"
        />
      </div>
