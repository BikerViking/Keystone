...
export default function Footer() {
  return (
    <footer
      role="contentinfo"
      className="footer-gradient bg-black py-10 text-sm text-lightgray"
    >
      <div className="container flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
        <nav aria-label="Footer" className="flex gap-4 sm:gap-6">
          <a href="/about" aria-label="Footer link to About" className="transition-colors hover:text-silver">About</a>
          <a href="/services" aria-label="Footer link to Services" className="transition-colors hover:text-silver">Services</a>
          <a href="/contact" aria-label="Footer link to Contact" className="transition-colors hover:text-silver">Contact</a>
        </nav>
        <div className="flex flex-col items-center gap-2">
          <div className="flex gap-2">
            <a href="tel:2673099000" className="transition-colors hover:text-silver">(267) 309-9000</a>
            <span className="hidden sm:inline">|</span>
            <a href="mailto:info@keystonenotarygroup.com" className="transition-colors hover:text-silver">info@keystonenotarygroup.com</a>
          </div>
      ...
      <p className="mt-6 text-center">&copy; {CURRENT_YEAR} Keystone Notary Group, LLC. All rights reserved.</p>
    </footer>
  );
}
